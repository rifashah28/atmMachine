...
public class Customer {
	...
	public Customer(String firstName, String lastName, String accountNumber, String pinNumber) {
		...
		// here i create the account for the customer and set the amount in the account to 100$
		Account account = new Account(accountNumber,pinNumber,balance);
	...
	/*====================================================
	 * shouldnt this be in another place like under get balance atm class/function
	 * 
	 * 
	 */
